...
object Kotlin{
    ...
    const val coroutinesCommon = "org.jetbrains.kotlinx:kotlinx-coroutines-core-common:${Versions.coroutinesVersion}"
...
object ArrowKotlin{
    ...
    const val arrowEffectExtensions = "io.arrow-kt:arrow-effects-extensions:${Versions.arrowVersion}"

    const val arrowEffectRx = "io.arrow-kt:arrow-effects-rx2-data:${Versions.arrowVersion}"
    const val arrowEffectRxExtensions = "io.arrow-kt:arrow-effects-rx2-extensions:${Versions.arrowVersion}"

    const val arrowEffectCoroutine = "io.arrow-kt:arrow-effects-kotlinx-coroutines-data:${Versions.arrowVersion}"
    const val arrowEffectCoroutineExtensions = "io.arrow-kt:arrow-effects-kotlinx-coroutines-extensions:${Versions.arrowVersion}"
...
object Support{
    ...
    const val vectorDrawable = "androidx.vectordrawable:vectordrawable:${Versions.supportLibraryVersion}"
...
object ArchComponent{
    //architecture comps
    const val lifecycleRuntime = "androidx.lifecycle:lifecycle-runtime:${Versions.archComponentVersion}"
    const val lifecycleExtension = "androidx.lifecycle:lifecycle-extensions:${Versions.archComponentVersion}"
    const val lifecycleCompiler = "androidx.lifecycle:lifecycle-compiler:${Versions.archComponentVersion}"
}
...
object AndroidKts{
    ...
    const val collectionKts = "androidx.collection:collection-ktx:${Versions.androidKotlinExtVersion1}"
    const val viewModelKts = "androidx.lifecycle:lifecycle-viewmodel-ktx:${Versions.androidKotlinExtVersion2}"
}
...
object RxJava{
    ...
    const val rxPreferences = "com.f2prateek.rx.preferences2:rx-preferences:${Versions.rxPreferencesVersion}"
    ...
    const val rxBindingCompat = "com.jakewharton.rxbinding3:rxbinding-appcompat:${Versions.rxBindingVersion}"
    const val rxBindingMaterial = "com.jakewharton.rxbinding3:rxbinding-material:${Versions.rxBindingVersion}"
}
...
object Ui{
    //Ui
    const val roundCardView = "com.github.captain-miao:optroundcardview:${Versions.roundCardViewVersion}"
    const val recyclerViewtemDecoration = "com.bignerdranch.android:simple-item-decoration:${Versions.recyclerViewItemDecorationVersion}"
...
object Utils{
    ...
    const val flipperNetworkPlugin = "com.facebook.flipper:flipper-network-plugin:${Versions.flipperVersion}"
    const val flipperFrescoPlugin = "com.facebook.flipper:flipper-fresco-plugin:${Versions.flipperVersion}"
...
object Database{
    const val sqlDelightAndroidAdapter = "com.squareup.sqldelight:android-driver:${Versions.sqlDelightVersion}"
    const val sqlDelightRuntime = "com.squareup.sqldelight:runtime-jvm:${Versions.sqlDelightVersion}"
...
object ObjectboxLib{
    ...
    const val objectboxBrowser = "io.objectbox:objectbox-android-objectbrowser:${Versions.objectboxVersion}"
...
object ButterKnifeLib{
    ...
    const val butterKnifeCompiler = "com.jakewharton:butterknife-compiler:${Versions.butterKnifeVersion}"
}
